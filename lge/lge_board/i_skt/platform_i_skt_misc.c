...
static struct isa1200_reg_cmd isa1200_init_seq[] = {
	...
	{LGE_ISA1200_SCTRL , 0x1F}, 		/* LDO:3V */ // 0x0F

#if 0
	{LGE_ISA1200_HCTRL0, 0x12},		/* [4:3]10 : PWM Generation Mode [1:0]01 : Divider 1/256 */
	{LGE_ISA1200_HCTRL1, 0xC0},		/* [7] 1 : Ext. Clock Selection, [5] 0:LRA, 1:ERM */
	{LGE_ISA1200_HCTRL3, 0x13},		/* [6:4] 1:PWM/SE Generation PLL Clock Divider */

	{LGE_ISA1200_HCTRL4, 0x83},		/* bk */
...
static struct lge_isa1200_platform_data lge_isa1200_platform_data = {
	...
	.default_vib_strength = 117, // 113, //99, //213,
