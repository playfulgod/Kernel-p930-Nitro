...
/*
void failed_access_uart(bool val)
{
  char *argv_on[] = { "/system/bin/sh","chmod 600 /dev/felica", "start", "-n", "com.lge.FeliCaTestFN/.FelicaTestFN", "--activity-clear-top", NULL };
  char *argv_off[] = { "/system/bin/sh","chmod 666 /dev/felica", "start", "-n", "com.lge.FeliCaTestFN/.FelicaTestFN", "--activity-clear-top", NULL };
