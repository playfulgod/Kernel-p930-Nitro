...
static int felica_open (struct inode *inode, struct file *fp)
{
  ...
  {
    #ifdef FEATURE_DEBUG_LOW
    FELICA_DEBUG_MSG("[FELICA] /dev/felica is already openned. \n");
    #endif
  ...
  {
    #ifdef FEATURE_DEBUG_LOW
    FELICA_DEBUG_MSG("[FELICA] felica_open - start \n");
    #endif
...
*/
static int felica_ioctl (struct inode *inode, struct file *fp, unsigned int cmd, unsigned long arg)
{
